"""Adapter skeleton for MSD-GNN.

This file intentionally does not contain the official MSD-GNN source code. The method is a
...
class MsdGnnAdapter(ExternalBaselineAdapter):
    baseline_name = "MSD-GNN"
    citation_hint = "multi-scale dynamic graph neural network baseline. Please cite and follow the original authors' license."


def build_model(*args, **kwargs):
    return MsdGnnAdapter(*args, **kwargs)
