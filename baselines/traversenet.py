"""Adapter skeleton for TraverseNet.

This file intentionally does not contain the official TraverseNet source code. The method is a
...
class TraversenetAdapter(ExternalBaselineAdapter):
    baseline_name = "TraverseNet"
    citation_hint = "dynamic spatio-temporal graph baseline. Please cite and follow the original authors' license."


def build_model(*args, **kwargs):
    return TraversenetAdapter(*args, **kwargs)
