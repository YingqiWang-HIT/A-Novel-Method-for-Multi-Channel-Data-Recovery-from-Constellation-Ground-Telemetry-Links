"""Adapter skeleton for DSTGNN.

This file intentionally does not contain the official DSTGNN source code. The method is a
...
class DstgnnAdapter(ExternalBaselineAdapter):
    baseline_name = "DSTGNN"
    citation_hint = "dynamic spatio-temporal graph neural network baseline. Please cite and follow the original authors' license."


def build_model(*args, **kwargs):
    return DstgnnAdapter(*args, **kwargs)
