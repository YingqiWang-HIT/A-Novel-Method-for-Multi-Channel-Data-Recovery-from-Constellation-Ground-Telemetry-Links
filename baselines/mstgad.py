"""Adapter skeleton for MSTGAD.

This file intentionally does not contain the official MSTGAD source code. The method is a
...
class MstgadAdapter(ExternalBaselineAdapter):
    baseline_name = "MSTGAD"
    citation_hint = "multi-scale spatio-temporal graph anomaly/reconstruction baseline. Please cite and follow the original authors' license."


def build_model(*args, **kwargs):
    return MstgadAdapter(*args, **kwargs)
