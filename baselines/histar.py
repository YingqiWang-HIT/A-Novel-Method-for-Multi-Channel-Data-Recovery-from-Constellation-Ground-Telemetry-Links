"""Adapter skeleton for HiSTAR.

This file intentionally does not contain the official HiSTAR source code. The method is a
...
class HistarAdapter(ExternalBaselineAdapter):
    baseline_name = "HiSTAR"
    citation_hint = "hierarchical spatio-temporal representation baseline. Please cite and follow the original authors' license."


def build_model(*args, **kwargs):
    return HistarAdapter(*args, **kwargs)
