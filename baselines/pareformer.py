"""Adapter skeleton for PAREformer.

This file intentionally does not contain the official PAREformer source code. The method is a
...
class PareformerAdapter(ExternalBaselineAdapter):
    baseline_name = "PAREformer"
    citation_hint = "single-temporal-scale telemetry reconstruction baseline. Please cite and follow the original authors' license."


def build_model(*args, **kwargs):
    return PareformerAdapter(*args, **kwargs)
